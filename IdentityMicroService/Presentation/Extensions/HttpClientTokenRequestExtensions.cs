...
{
    public static async Task<TokenResponse> RequestEmailPasswordTokenAsync(this HttpMessageInvoker client,
        EmailPasswordTokenRequest request, CancellationToken cancellationToken = default)
    {
